...
MejoraSM es el sistema autónomo de estrategia, generación, aprobación y publicación de contenidos para **Mejora Continua** (mejoraok.com).
...
- **Agregador Social:** [Zernio API](https://zernio.com) (`https://zernio.com/api/v1/posts`).
  ...
  - **LinkedIn:** Vía `ZERNIO_LINKEDIN_ACCOUNT_ID` (Fase 5 — feed posts B2B).
...
- **Destino:** API central de contactos (`MejoraContactos` / `MejoraCRM`):
  ...
  - Acción: Desde `/conversaciones`, cuando un DM o comentario contiene intención comercial, el usuario pulsa **"Enviar a CRM"** derivando el lead con nombre, email, teléfono, red y nota contextual.
