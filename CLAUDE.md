...
- **Pendiente de Pablo, único:** agregar `https://mejorasm.mejoraok.com/app/reset.html` a **Authentication → URL Configuration → Redirect URLs** del proyecto Supabase — sin eso, el link del email de blanqueo de contraseña rebota. (El de `pabloeckert.github.io/MejoraSM/app/reset.html` puede quedar o sacarse; ya no es el camino principal.)
