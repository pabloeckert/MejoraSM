...
BEGIN
  ...
  DROP POLICY IF EXISTS "Allow all" ON doc_chunks;
  DROP POLICY IF EXISTS "Allow all" ON agent_config;
  DROP POLICY IF EXISTS "Allow all" ON dialogue_sessions;
  DROP POLICY IF EXISTS "Allow all" ON dialogue_messages;
  ...
  DROP POLICY IF EXISTS "Allow all" ON success_rules;
...
-- ═══════════════════════════════════════════
-- VERIFICAR/CREAR TABLAS (IF NOT EXISTS)
-- ═══════════════════════════════════════════
